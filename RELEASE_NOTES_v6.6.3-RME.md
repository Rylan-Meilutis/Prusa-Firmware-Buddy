...
### Additions since 6.6.2-RME
  ...
  * Material telemetry now reports the base polymer family independently from
    ...
    every supported printer, rather than only the INDX variants. MINI exposes
    the setting through RME/M865 while omitting the local selector to remain
    within its firmware partition.
