...
using Frames = FrameDefinitionList<ScreenPrintPreview::FrameStorage,
    ...
    FrameDefinition<Phase::gcode_incompatible_warning, screen_print_preview::FrameCompatibilityChecks, Phase::gcode_incompatible_warning, screen_print_preview::FrameCompatibilityChecks::GCodeMode {}>,
    FrameDefinition<Phase::gcode_incompatible_fatal, screen_print_preview::FrameCompatibilityChecks, Phase::gcode_incompatible_fatal, screen_print_preview::FrameCompatibilityChecks::GCodeMode {}>,
