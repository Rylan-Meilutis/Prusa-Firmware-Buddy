...
float MI_FS_REF_NINS::read_value_impl(PhysicalToolIndex ix) {
    return config_store().get_extruder_fs_ref_nins_value(ix.to_raw());
}

void MI_FS_REF_NINS::store_value_impl(PhysicalToolIndex ix, float set) {
...
float MI_FS_REF_INS::read_value_impl(PhysicalToolIndex ix) {
    return config_store().get_extruder_fs_ref_ins_value(ix.to_raw());
}

void MI_FS_REF_INS::store_value_impl(PhysicalToolIndex ix, float set) {
...
float MI_SIDE_FS_REF_NINS::read_value_impl(PhysicalToolIndex ix) {
    return config_store().get_side_fs_ref_nins_value(ix.to_raw());
}

void MI_SIDE_FS_REF_NINS::store_value_impl(PhysicalToolIndex ix, float set) {
...
float MI_SIDE_FS_REF_INS::read_value_impl(PhysicalToolIndex ix) {
    return config_store().get_side_fs_ref_ins_value(ix.to_raw());
}

void MI_SIDE_FS_REF_INS::store_value_impl(PhysicalToolIndex ix, float set) {
