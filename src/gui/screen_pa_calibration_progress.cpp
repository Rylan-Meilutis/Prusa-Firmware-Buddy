...
const char *phase_text(const PhasesPressureAdvanceCalibration phase) {
    switch (phase) {
    case PhasesPressureAdvanceCalibration::heating:
        return N_("Heating nozzle");
    case PhasesPressureAdvanceCalibration::homing:
        return N_("Homing");
    case PhasesPressureAdvanceCalibration::probing:
        return N_("Probing anchor area");
    case PhasesPressureAdvanceCalibration::measuring:
        return N_("Measuring nozzle pressure");
    case PhasesPressureAdvanceCalibration::computing:
        return N_("Computing the best value");
    case PhasesPressureAdvanceCalibration::cleanup:
        return N_("Cleaning nozzle");
    case PhasesPressureAdvanceCalibration::result:
        return N_("Pressure advance result");
    case PhasesPressureAdvanceCalibration::complete:
        return N_("Calibration complete");
    case PhasesPressureAdvanceCalibration::failed:
        return N_("Calibration stopped; fallback applied");
    }
