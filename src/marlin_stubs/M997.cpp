...
void PrusaGcodeSuite::M997() {
    ...
    // An RME request is queued after its initial validation. Recheck the
    // shared latch at execution time so a Connect/Link transfer that starts
    // in that interval cannot overlap bootloader staging.
