...
public:
    ...
    virtual void transmit_node_execute_command_request(NodeId remote_node_id, Command, WritableBytes) = 0;
    virtual void transmit_file_read_response(NodeId remote_node_id, uint8_t transfer_id, WritableBytes data) = 0;
