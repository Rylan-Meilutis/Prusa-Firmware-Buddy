...
#endif
{
    ...
    StoreItemArray<uint32_t, uint32_t { 0 }, ItemFlag::printer_state, journal::hash("Loaded Filament Color"), 16, EXTRUDERS> loaded_filament_color_rgb;
    ...
    StoreItemArray<uint32_t, uint32_t { 0 }, ItemFlag::user_presets, journal::hash("Custom Filament Color RGB"), 16, 8> custom_filament_color_rgb;
    ...
    StoreItem<bool, true, ItemFlag::features, journal::hash("Filament movement detection V2")> filament_movement_detection;
