...
#endif
{
    ...
    StoreItem<uint32_t, 0x300080, ItemFlag::user_interface, journal::hash("Status LED Printing Color")> status_led_printing_color;
    ...
    StoreItem<uint32_t, 0x300080, ItemFlag::user_interface, journal::hash("USB Status LED Printing Color")> usb_status_led_printing_color;
