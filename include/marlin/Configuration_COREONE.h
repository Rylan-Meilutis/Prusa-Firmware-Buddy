 ...
 */
    ...
    // stored offset = measured edge - BACK_NOMINAL. BACK_NOMINAL includes a +3.2/2 mm nozzle radius.
    ...
    // 8.535 = 8.25 (6.65 + 3.2/2) + 0.285 (empirical loadcell-vs-V-groove median, 7 units). INDX_TODO: revisit.
