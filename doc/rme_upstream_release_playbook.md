...
Keep xBuddy-extension RGBW PWM on its dedicated approximately 977 Hz TIM2 carrier. The former approximately 23.5 kHz carrier produced irregular low-duty strip response, so adjacent color values could render inconsistently or appear fully off. Do not alter TIM3 fan and chamber-light timing when tuning RGBW output.
