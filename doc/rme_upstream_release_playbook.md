...
Verify bounded 1024-byte CRC32 raw downloads, the legacy Base64 fallback, RME
header ownership during both transfer directions, and full unsigned 32-bit
transaction-ID round trips.
