...
## Summary
  ...
  * New features and improvements
    ...
    * Added `M976` stationary loadcell calibration for per-print pressure advance and extrusion-health monitoring, including per-hotend temperature set/wait for slicer-driven tool and MMU sequences [C1, C1 INDX, XL, MK4, iX]
      ...
      * Two hidden serial recovery slots remain active beyond the normal G-code queue, including during blocking heater waits; `M601` cancels the wait and pauses immediately, while `M876 S<n>` directly selects the current dialog button, keeping MMU Retry, abort, and stuck-filament recovery responsive when normal buffering is full
...
2e6cb2696  2026-07-19  Add guided manual PA calibration
0bd1ea8bc  2026-07-19  Add persistent loaded filament colors
0f7768389  2026-07-19  Fix persistent custom color name lifetime
492aa0b3e  2026-07-19  Refine PA material safety and Connect light handling
889a4e637  2026-07-19  Keep MINI color UI within flash budget
74da392e0  2026-07-19  Add guided PA calibration progress workflow
1287e6ca8  2026-07-19  Polish PA probing and chamber light telemetry
...
463c99312  2026-07-20  Use continuous PA calibration confidence
cb7a5bca0  2026-07-20  Fix MMU PA preparation and stack crash
decfe8c03  2026-07-20  Fix MMU PA sensor namespace
81263b4ee  2026-07-20  Fix firmware picker and PA probe preparation
