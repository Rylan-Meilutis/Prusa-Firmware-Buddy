...
## Summary
  ...
  * New features and improvements
    ...
    * Added `M976` stationary loadcell calibration for per-print pressure advance and extrusion-health monitoring, including per-hotend temperature set/wait for slicer-driven tool and MMU sequences [C1, C1 INDX, XL, MK4, iX]
      ...
      * Actionable serial errors open two reserved receive slots beyond the normal G-code queue; `M876 S<n>` directly selects the current dialog button, keeping MMU Retry, abort, and stuck-filament recovery commands responsive when normal buffering is full
