...
- **Faster compatible USB serial bursts:** The USB CDC port retains 115200 host compatibility and legacy numbered G-code/storage behavior while using larger multi-packet RX/TX FIFOs for RME file and firmware transfers. USB CDC is not physically limited to the selected baud value; 57600 remains reserved for diagnostic logging.
