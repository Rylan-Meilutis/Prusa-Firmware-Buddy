...
This branch contains the RME custom firmware based on Prusa Firmware Buddy 6.6.0. It keeps the standard Buddy firmware foundation while adding features for OctoPrint workflows, lighting control, screen dimming, chamber behavior, fleet configuration, and printer maintenance.
