...
- **INDX purge-bucket management:** The pellet counter has a configurable automatic-pause threshold in the Nozzle Cleaner menu. `M1986` can report, set, or reset the count and configure the threshold; serial prints receive matching host pause/resume actions when the bucket must be emptied. See the [M1986 guide](doc/gcode/M1986.md).
