if(NOT DEFINED NO_CCACHE)
  ...
  if(CCACHE STREQUAL "CCACHE-NOTFOUND")
    ...
    set(CMAKE_CXX_COMPILER_LAUNCHER
        "${CCACHE};sloppiness=pch_defines,time_macros;namespace=${PRINTER}-${CMAKE_BUILD_TYPE}-${BOOTLOADER};base_dir=${CMAKE_SOURCE_DIR};ignore_options=--specs=nano.specs --specs=nosys.specs"
        )
