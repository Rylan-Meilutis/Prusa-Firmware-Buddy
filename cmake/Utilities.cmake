...
function(get_recommended_gcc_version var)
  ...
  if(NOT "${RETVAL}" STREQUAL "0")
    message(
      FATAL_ERROR
        "Failed to obtain recommended gcc version from utils/bootstrap.py using ${Python3_EXECUTABLE}: ${RECOMMENDED_ERROR}"
      )
  endif()
...
function(get_dependency_directory dependency var)
  ...
  if(NOT "${RETVAL}" STREQUAL "0")
    message(
      FATAL_ERROR
        "Failed to find directory with ${dependency} using ${Python3_EXECUTABLE}: ${DEPENDENCY_ERROR}"
      )
  endif()
...
function(get_dependency_version dependency var)
  ...
  if(NOT "${RETVAL}" STREQUAL "0")
    message(
      FATAL_ERROR
        "Failed to find version for ${dependency} using ${Python3_EXECUTABLE}: ${DEPENDENCY_ERROR}"
      )
  endif()
